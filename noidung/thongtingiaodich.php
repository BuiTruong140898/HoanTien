...
<?php require 'mysql/conn.php'; ?>
    ...
    <div class="card mb-3" style="width: 100%">
        <div class="card-header">
            ...
            $sql="SELECT sum(sotien) from thongtingiaodich where trangthai='xong' and nguoidung='".$_SESSION['start']."'";
            ...
            $sql="SELECT sum(sotien) from thongtingiaodich where trangthai in('chờ duyệt','xong') and nguoidung='".$_SESSION["start"]."'";
            $chietkhaudaduyet=mysqli_query($con,$sql);
            $rowchietkhaudaduyet=mysqli_fetch_array($chietkhaudaduyet);
            echo $rowchietkhaudaduyet["0"].'đ';
             ?></
                ...
                <table class="table table-bordered" id="tblCashback" width="100%" cellspacing="0">
                    ...
                    <tbody>
                       ...
                       $i= mysqli_num_rows($rows);
                            if(!$i){
                                 $sql="select * from thongtingiaodich where trangthai like '%".$giaodich."%' and nguoidung='".$_SESSION['start']."'" ;
                            ...
                            $sql="select * from thongtingiaodich where iddonhang =".$so." and nguoidung='".$_SESSION['start']."'"  ; 
