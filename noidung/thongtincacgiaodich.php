...
<?php require 'mysql/conn.php'; ?>
    <div class="card mb-3" style="width: 100%">
        <div class="card-header">
            ...
            $sql="SELECT sum(sotien) from thongtingiaodich where trangthai='xong'";
            ...
            $sql="SELECT sum(sotien) from thongtingiaodich where trangthai='xong' or trangthai='chờ duyệt'";
            $chietkhaudaduyet=mysqli_query($con,$sql);
            $rowchietkhaudaduyet=mysqli_fetch_array($chietkhaudaduyet);
            echo $rowchietkhaudaduyet["0"].'đ';
             ?></div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <div class="input-group" style="background-color:#f7f7f7; width:98%; padding:20px; border: 1px solid #dee2e6; margin-left: auto; margin-right: auto; margin-bottom:10px">
                    ...
                    <input style="width: 90%" id="txtGlobalSearch" class="form-control form-control-ck" name="giaodich" type="text" placeholder="Search theo ID đơn hàng, Đối tác, trang thai ">
                    ...
                    <tbody>
                        ...
                        <?php 
                         if(isset($_GET["search_giaodich"])){
                            ...
                            $sql="select * from thongtingiaodich where iddonhang =".$so." or doitac like '%".$giaodich."%'  or trangthai = '".$giaodich."'"  ; 
                        }
                        else
