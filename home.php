...
<body style="margin-top: 80px; margin-bottom:50px ">
    ...
    <div id="wrapper">
        <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top navbar-fixed-top" style="background-color:#FF4E4EFF; height: 70px"  role="navigation">
            <div style="padding-top:10px" class="navbar-header">
               ...
               <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                ...
                <a  href="home.php" style="text-decoration: none"><div style=" float:left;color: white; margin-left: 80px;  font-weight: bold; font-size: 30px">Hoàn tiền</div></a>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="background-color:#FF4E4EFF; height: 65px; font-size: 18px ; color: white ">
                        <i class="fa fa-user fa-fw"></i><?php echo $_SESSION['start']?> <i class="fa fa-caret-down"></i>
                </a>
